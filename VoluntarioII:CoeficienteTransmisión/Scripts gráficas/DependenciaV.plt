...
plot FicheroDatos1 using 1:2 with lines lc 1 t " N=500,  λ=0.1",  FicheroDatos2 using 1:2 with lines lc 2 t " N=1000,  λ=1", FicheroDatos3 using 1:2 with lines lc 4 t " N=2000,  λ=0.5"
